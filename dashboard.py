...
class ReportDropdown(Dropdown):
    ...
    def build_component(self, entity_id, model):
        ...
        #self.label=type(model).__name__
...
# ex=ReportDropdown()
# print("string")
# print(ex.build_component(5, load_model()))
...
class Header(BaseComponent):
    ...
    def build_component(self, entity_id, model):
        ...
        #### YOUR CODE HERE
        return H1(f"Model: {model.name} performance")
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        #### YOUR CODE HERE
        axis.set_title("Cumulative Event Counts")
